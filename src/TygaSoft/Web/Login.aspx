...
<head runat="server">
    ...
    <script src="/Me/Scripts/plugins/Jeasyui15/jquery.min.js" type="text/javascript"></script>
    <script src="/Me/Scripts/Plugins/Jeasyui15/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="/Me/Scripts/Plugins/Jeasyui15/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
    <script src="/Me/Scripts/JeasyuiHelper.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="w login">
        <div class="main">
            <div class="loginl">
	            <img src="/Me/Images/loginl.jpg" alt="" />
            </div>
            <div class="loginr">
                ...
                <div id="loginInfo" class="content">
                    ...
                    <div class="control-group">
                        ...
                        <img border="0" id="imgCode" src="/Me/h/vc.html?vcType=login" alt="看不清，单击换一张" onclick="this.src='/Me/h/vc.html?vcType=login&abc='+Math.random()" style="vertical-align:middle;line-height: 38px;height: 38px; width:100px; margin-bottom:3px;" />
                    </div>
    ...
    <script type="text/javascript" src="/Me/Scripts/Login.js"></script>
