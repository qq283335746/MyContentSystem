var DlgFiles = {
        ...
        try {
            ...
            dlgFm.form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    //console.log('param--' + param + '--' + typeof (param) + '--' + JSON.stringify(param));
                    //return false;
                    return true;
                },
    ...
    LoadData: function (pageIndex, pageSize, funName) {
        ...
        $.ajax({
            url: "/Me/Services/Service.svc/GetSitePictureList",
            type: "post",
            data: '{"model":' + sData + '}',
    ...
    OnDelete: function (tableName) {
        ...
        $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
            if (r) {
                $.ajax({
                    url: "/Me/Services/Service.svc/DeleteSitePicture",
                    type: "post",
