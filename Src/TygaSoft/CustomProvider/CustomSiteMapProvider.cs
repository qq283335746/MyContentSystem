    ...
    public class CustomSiteMapProvider : SiteMapProvider
    {
        ...
        public override SiteMapNode FindSiteMapNode(string rawUrl)
        {
            ...
            if (currNode == null)
            {
                ...
                {
                    currNode = list.FirstOrDefault(m => m.Title == EnumData.MenuName.首页.ToString() && !m.Url.Contains(FormsAuthentication.DefaultUrl.Replace("~", "")));
                }
        ...
        public override SiteMapNode GetParentNode(SiteMapNode node)
        {
            ...
            if (parentNode.Title == EnumData.MenuName.禁止匿名访问.ToString() || parentNode.Title == EnumData.MenuName.匿名访问.ToString()) return null;
        ...
        protected override SiteMapNode GetRootNodeCore()
        {
            ...
            if (HttpContext.Current.User.Identity.IsAuthenticated)
            {
                rootNode = list.FirstOrDefault(m => m.Title == EnumData.MenuName.首页.ToString() && !m.Url.Contains(FormsAuthentication.DefaultUrl.Replace("~", "")));
            }
