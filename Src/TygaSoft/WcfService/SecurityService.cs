    ...
    public class SecurityService : ISecurity
    {
        ...
        public ResResultModel SaveUser(UserModel model)
        {
            try
            {
                ...
                {
                    return ResResult.Response(false, MC.L_InvalidPassword, "");
                }
        ...
        public ResResultModel GetRolesForUser(string userName)
        {
            try
            {
                MenusDataProxy.ValidateAccess((int)EnumData.OperationAccess.浏览, true);
        ...
        public ResResultModel ChangePassword(string username, string oldPassword, string password)
        {
            try
            {
                ...
                if (!Regex.IsMatch(password, Membership.PasswordStrengthRegularExpression)) return ResResult.Response(false, MC.L_InvalidPassword, "");
                if (!Membership.ValidateUser(username, oldPassword)) return ResResult.Response(false, MC.L_InvalidOldPsw, "");
