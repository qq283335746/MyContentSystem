...
namespace TygaSoft.SysHelper
{
    public static class MC
    {
        ...
        public const string L_InvalidError = "您未登录或登录信息已过期，请重新登录！";
        public const string L_NotIsLockedOutError = "只有“已锁定”的用户才能执行此操作！";
        public const string L_ExistName = "“{0}”已存在，请更换一个再重试！";
        public const string L_InvalidAccount = "用户名或密码不正确！";
        public const string L_InvalidVC = "验证码不正确！";
        public const string L_InvalidVCCookie = "验证码不存在或已过期！";
        public const string L_InvalidPsw = "密码不正确！";
        public const string L_InvalidOldPsw = "当前密码不正确！";
        public const string L_AccountLock = "您的账号已被锁定，请联系管理员先解锁后才能登录！";
        public const string L_AccountAllow = "您的帐户尚未获得批准，请联系管理员！";
        public const string L_InvalidPassword = "密码应由数字、字母、特殊字符（不包括“&”）组成，且是6-30位的字符串！";
